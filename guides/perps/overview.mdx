...
description: "Long or short listed and pre-IPO stock tokens. Cross-margin, up to 5×, one signature."
mode: "wide"
---

Vanna lists a perps market for each supported stock token, listed and pre-IPO. Positions are built from credit + Jupiter, not a synthetic order book, and open from the same cross-margin account as Farm and Swap.

...
Browser RPC is `NEXT_PUBLIC_SOLANA_RPC_URL` (hosted: `https://rpc-devnet.solana.vanna.finance`). Server routes use `FORK_RPC_URL` on loopback when the app and Surfpool share a VM.
